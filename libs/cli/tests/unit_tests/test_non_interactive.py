...
class TestQuietMode:
    ...
    async def test_console_creation(
        ...
        with (
            patch(
                "code2workspace_cli.non_interactive.Console",
...
class TestToolDisplayInLogs:
    ...
    def test_task_tool_logs_subagent_type_when_args_present(self) -> None:
        ...
        assert "task [research-helper]" in rendered
...
class TestFastFollowLangsmithLink:
    ...
    async def test_prints_link_when_lookup_ready(self) -> None:
        ...
        with (
            ...
            patch(
                "code2workspace_cli.non_interactive._start_langsmith_thread_url_lookup",
...
class TestNonInteractivePrompt:
    ...
    async def test_initial_skill_wraps_prompt_and_metadata(self) -> None:
        ...
        with (
            ...
            patch(
                "code2workspace_cli.skills.invocation.discover_skills_and_roots",
                return_value=([skill], []),
            ),
            patch(
