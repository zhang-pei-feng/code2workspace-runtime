...
class TestGetClipboardImage:
    ...
    @patch("code2workspace_cli.media_utils.sys.platform", "linux")
    def test_unsupported_platform_returns_none_and_warns(self) -> None:
        ...
        with patch("code2workspace_cli.media_utils.logger") as mock_logger:
            result = get_clipboard_image()
            assert result is None
            mock_logger.warning.assert_called_once()
            assert "linux" in mock_logger.warning.call_args[0][1]

    @patch("code2workspace_cli.media_utils.sys.platform", "darwin")
    @patch("code2workspace_cli.media_utils._get_macos_clipboard_image")
    ...
    @patch("code2workspace_cli.media_utils.sys.platform", "darwin")
    @patch("code2workspace_cli.media_utils.subprocess.run")
    @patch("code2workspace_cli.media_utils._get_executable")
    ...
    @patch("code2workspace_cli.media_utils.sys.platform", "darwin")
    @patch("code2workspace_cli.media_utils._get_clipboard_via_osascript")
    @patch("code2workspace_cli.media_utils.subprocess.run")
