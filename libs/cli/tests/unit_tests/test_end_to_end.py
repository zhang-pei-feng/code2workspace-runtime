"""End-to-end unit tests for code2workspace-cli with fake LLM models."""
...
def mock_settings(
    ...
    # Patch settings
    with patch("code2workspace_cli.agent.settings") as mock_settings_obj:
        mock_settings_obj.user_code2workspace_dir = tmp_path / "agents"
...
class TestCode2WorkspaceCLIEndToEnd:
    """Test suite for end-to-end code2workspace-cli functionality with fake LLM."""
