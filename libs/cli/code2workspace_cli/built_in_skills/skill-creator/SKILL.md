...
```
~/.code2workspace/agent/skills/     # user skills (lowest precedence)
├── skill-name-1/
│   └── SKILL.md
└── ...

<project-root>/.code2workspace/skills/   # project skills (higher precedence)
├── skill-name-2/
│   └── SKILL.md
└── ...
```
...
```bash
# User skills (default)
scripts/init_skill.py <skill-name> --path ~/.code2workspace/agent/skills

# Project skills
scripts/init_skill.py <skill-name> --path .code2workspace/skills
```
...
#### Option B: `code2workspace skills create` (quick start)
...
code2workspace skills create <skill-name>

# Create in project skills directory
code2workspace skills create <skill-name> --project
```

Use `init_skill.py` when the skill will include bundled resources (`scripts/`, `references/`, `assets/`). Use `code2workspace skills create` for a quick, minimal starting point.
