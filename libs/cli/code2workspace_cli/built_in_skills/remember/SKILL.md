...
**Global** (`~/.code2workspace/agent/AGENTS.md`): Universal preferences across all projects
**Project** (`.code2workspace/AGENTS.md`): Project-specific conventions and decisions
...
### Skill Location
`~/.code2workspace/agent/skills/<skill-name>/SKILL.md`
