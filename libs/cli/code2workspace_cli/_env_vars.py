"""Canonical registry of `CODE2WORKSPACE_CLI_*` environment variables.

Every env var the CLI reads whose name starts with `CODE2WORKSPACE_CLI_` must
...
like `"CODE2WORKSPACE_CLI_FOO"` appears in source code instead of a constant
...
!!! note
    ...
    and provider credentials: setting `CODE2WORKSPACE_CLI_{NAME}` takes priority
    over `{NAME}`.  For example, `CODE2WORKSPACE_CLI_OPENAI_API_KEY` overrides
...
AUTO_UPDATE = "CODE2WORKSPACE_CLI_AUTO_UPDATE"
"""Enable automatic CLI updates ('1', 'true', or 'yes')."""

DEBUG = "CODE2WORKSPACE_CLI_DEBUG"
"""Enable verbose debug logging to a file."""

DEBUG_FILE = "CODE2WORKSPACE_CLI_DEBUG_FILE"
"""Path for the debug log file (default: `/tmp/code2workspace_debug.log`)."""

EXTRA_SKILLS_DIRS = "CODE2WORKSPACE_CLI_EXTRA_SKILLS_DIRS"
"""Colon-separated paths added to the skill containment allowlist."""

LANGSMITH_PROJECT = "CODE2WORKSPACE_CLI_LANGSMITH_PROJECT"
"""Override LangSmith project name for agent traces."""

NO_UPDATE_CHECK = "CODE2WORKSPACE_CLI_NO_UPDATE_CHECK"
"""Disable automatic update checking when set."""

SERVER_ENV_PREFIX = "CODE2WORKSPACE_CLI_SERVER_"
"""Environment variable prefix used to pass CLI config to the server subprocess."""

SHELL_ALLOW_LIST = "CODE2WORKSPACE_CLI_SHELL_ALLOW_LIST"
"""Comma-separated shell commands to allow (or 'recommended'/'all')."""

USER_ID = "CODE2WORKSPACE_CLI_USER_ID"
