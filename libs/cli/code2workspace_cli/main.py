...
def check_cli_dependencies() -> None:
    ...
    if missing:
        ...
        print("  pip install code2workspace[cli]")  # noqa: T201  # CLI output for missing dependencies
...
def check_optional_tools(*, config_path: Path | None = None) -> list[str]:
    ...
    Args:
        config_path: Path to config file.
            ...
            Defaults to `~/.code2workspace/config.toml`.
...
async def _preload_session_mcp_server_info(
    *,
    ...
    from code2workspace_cli.mcp_tools import resolve_and_load_mcp_tools
...
def parse_args() -> argparse.Namespace:
    ...
    """
    from code2workspace_cli.deploy import setup_deploy_parsers
    from code2workspace_cli.output import add_json_output_arg
    from code2workspace_cli.skills import setup_skills_parser
    ...
    # `code2workspace <subcommand> -h` shows context-specific help.
    ...
    def _lazy_help(fn_name: str) -> Callable[[], None]:
        def _show() -> None:
            from code2workspace_cli import ui
...
async def run_textual_cli_async(
    ...
    *,
    ...
    from code2workspace_cli.app import AppResult, run_textual_app
    from code2workspace_cli.config import (
        _get_default_model_spec,
        detect_provider,
        settings,
    )
    from code2workspace_cli.model_config import ModelConfigError, ModelSpec
    ...
    try:
        ...
        from code2workspace_cli.config import console
...
def cli_main() -> None:
    ...
    try:
        ...
        from code2workspace_cli.config import console, settings
        ...
        if args.default_model is not None:
            ...
            from code2workspace_cli.model_config import ModelSpec
        ...
        if args.command == "help":
            from code2workspace_cli.ui import show_help

            show_help()
        elif args.command == "agents":
            from code2workspace_cli.agent import list_agents, reset_agent
            from code2workspace_cli.ui import show_agents_help
            ...
            from code2workspace_cli.skills import execute_skills_command

            execute_skills_command(args)
        elif args.command == "init":
            from code2workspace_cli.deploy import execute_init_command

            execute_init_command(args)
        elif args.command == "dev":
            from code2workspace_cli.deploy import execute_dev_command

            execute_dev_command(args)
        elif args.command == "deploy":
            from code2workspace_cli.deploy import execute_deploy_command
            ...
            from code2workspace_cli.ui import show_threads_help
            ...
            from code2workspace_cli.non_interactive import run_non_interactive
