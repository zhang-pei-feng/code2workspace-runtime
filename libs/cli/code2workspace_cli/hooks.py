...
Loads hook configuration from `~/.code2workspace/hooks.json` and fires matching
...
Config format (`~/.code2workspace/hooks.json`):
...
def _load_hooks() -> list[dict[str, Any]]:
    ...
    from code2workspace_cli.model_config import DEFAULT_CONFIG_DIR
