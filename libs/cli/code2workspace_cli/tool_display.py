...
from code2workspace_cli.config import MAX_ARG_LENGTH, get_glyphs
from code2workspace_cli.unicode_security import strip_dangerous_unicode
...
def format_tool_display(tool_name: str, tool_args: dict) -> str:
    ...
    if tool_name in {"read_file", "write_file", "edit_file"}:
        ...
        if "command" in tool_args:
            ...
            from code2workspace.backends import DEFAULT_EXECUTE_TIMEOUT
