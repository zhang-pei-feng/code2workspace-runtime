...
from code2workspace_cli.input import IMAGE_PLACEHOLDER_PATTERN, VIDEO_PLACEHOLDER_PATTERN
...
from code2workspace_cli.widgets.history import HistoryManager
...
def _default_history_path() -> Path:
    ...
    preventing test runs from polluting `~/.code2workspace/history.jsonl`.
    """
    return Path.home() / ".code2workspace" / "history.jsonl"
...
if TYPE_CHECKING:
    ...
    from code2workspace_cli.input import MediaTracker, ParsedPastedPathPayload
...
class ChatTextArea(TextArea):
    ...
    async def _flush_paste_burst(self) -> None:
        ...
        from code2workspace_cli.input import parse_pasted_path_payload
...
class ChatInput(Vertical):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            history_file: Path to history file (default: ~/.code2workspace/history.jsonl)
    ...
    def _extract_leading_dropped_path_with_command_recovery(
        ...
        """
        from code2workspace_cli.input import extract_leading_pasted_file_path
