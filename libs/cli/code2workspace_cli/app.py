...
from code2workspace_cli._session_stats import (
    SessionStats,
    SpinnerStatus,
    format_token_count,
)
...
from code2workspace_cli._version import CHANGELOG_URL, DOCS_URL
...
from code2workspace_cli.widgets.welcome import WelcomeBanner
...
if TYPE_CHECKING:
    ...
    from code2workspace.backends import CompositeBackend
    ...
    from code2workspace_cli.mcp_tools import MCPServerInfo
    ...
    from code2workspace_cli.textual_adapter import TextualUIAdapter
    from code2workspace_cli.widgets.approval import ApprovalMenu
    from code2workspace_cli.widgets.ask_user import AskUserMenu
...
_COMMAND_URLS: dict[str, str] = {
    ...
    "/docs": DOCS_URL,
    "/feedback": "https://github.com/zhang-pei-feng/code2workspace/issues/new/choose",
}
...
class Code2WorkspaceApp(App):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        from code2workspace_cli.input import MediaTracker
    ...
    async def _post_paint_init(self) -> None:
        ...
        from code2workspace_cli.update_check import is_update_check_enabled
    ...
    async def _init_session_state(self) -> None:
        """Create session state in a thread (imports code2workspace_cli.sessions)."""
    ...
    def _discover_skills_and_roots(
        ...
        """
        from code2workspace_cli.skills.invocation import discover_skills_and_roots
    ...
    async def _start_server_background(self) -> None:
        ...
        if self._mcp_preload_kwargs is not None:
            from code2workspace_cli.main import _preload_session_mcp_server_info
    ...
    def _prewarm_deferred_imports() -> None:
        ...
        from code2workspace_cli.command_registry import ALWAYS_IMMEDIATE  # noqa: F401
        from code2workspace_cli.config import settings  # noqa: F401
        from code2workspace_cli.hooks import dispatch_hook  # noqa: F401
        from code2workspace_cli.model_config import ModelSpec  # noqa: F401
        from code2workspace_cli.textual_adapter import TextualUIAdapter  # noqa: F401
        from code2workspace_cli.update_check import is_update_check_enabled  # noqa: F401
        ...
        try:
            ...
            # TUI from rendering.
            from code2workspace.backends import DEFAULT_EXECUTE_TIMEOUT  # noqa: F401
        ...
        from code2workspace_cli.widgets.approval import ApprovalMenu  # noqa: F401
        from code2workspace_cli.widgets.ask_user import AskUserMenu  # noqa: F401
        from code2workspace_cli.widgets.model_selector import (
            ModelSelectorScreen,  # noqa: F401
        )
        from code2workspace_cli.widgets.thread_selector import (  # noqa: F401
    ...
    async def _check_for_updates(self) -> None:
        ...
        try:
            from code2workspace_cli._version import __version__ as cli_version

            if is_auto_update_enabled():
                from code2workspace_cli.update_check import perform_upgrade
    ...
    async def _show_whats_new(self) -> None:
        ...
        try:
            from code2workspace_cli.update_check import should_show_whats_new
        ...
        try:
            from code2workspace_cli._version import __version__ as cli_version
            from code2workspace_cli.update_check import mark_version_seen
    ...
    async def on_chat_input_submitted(self, event: ChatInput.Submitted) -> None:
        ...
        from code2workspace_cli.hooks import dispatch_hook

        await dispatch_hook("user.prompt", {})

        # /quit and /q always execute immediately, even mid-thread-switch.
        from code2workspace_cli.command_registry import ALWAYS_IMMEDIATE
    ...
    async def _build_thread_message(prefix: str, thread_id: str) -> str | Content:
        ...
        """
        from code2workspace_cli.config import build_langsmith_thread_url
    ...
    async def _handle_command(self, command: str) -> None:
        ...
        """
        from code2workspace_cli.config import newline_shortcut, settings
        ...
        if cmd in {"/quit", "/q"}:
            ...
            try:
                from code2workspace_cli._version import (
            ...
            try:
                ...
                from code2workspace_cli.model_config import clear_caches
    ...
    async def _handle_skill_command(self, command: str) -> None:
        ...
        """
        from code2workspace_cli.command_registry import parse_skill_command
    ...
    def _resolve_offload_budget_str(self) -> str | None:
        ...
        """
        from code2workspace_cli.config import create_model, settings
        ...
        try:
            ...
            from code2workspace_cli.offload import format_offload_limit
    ...
    async def _run_agent_task(
        ...
        *,
        ...
        if self._ui_adapter is None:
            return
        from code2workspace_cli.textual_adapter import execute_task_textual
    ...
    def exit(
        ...
        from code2workspace_cli.hooks import _dispatch_hook_sync, _load_hooks
    ...
    async def action_open_editor(self) -> None:
        ...
        from code2workspace_cli.editor import open_in_editor
    ...
    async def _show_notification_settings(self) -> None:
        ...
        from code2workspace_cli.model_config import is_warning_suppressed
        from code2workspace_cli.widgets.notification_settings import (
            WARNING_TOGGLES,
    ...
    async def _show_thread_selector(self) -> None:
        ...
        from code2workspace_cli.sessions import get_cached_threads, get_thread_limit
        from code2workspace_cli.widgets.thread_selector import ThreadSelectorScreen
    ...
    async def _switch_model(
        ...
        *,
        ...
        Args:
            ...
            extra_kwargs: Extra constructor kwargs from `--model-params`.
        """
        from code2workspace_cli.config import create_model, detect_provider, settings
        from code2workspace_cli.model_config import (
            ModelSpec,
            ...
            if has_creds is False and provider is not None:
                ...
                detail = (
                    ...
                    if env_var
                        ...
                        "Add it to ~/.code2workspace/config.toml with an "
                        "api_key_env field"
                    )
                )
                await self._mount_message(
            ...
            if not await asyncio.to_thread(save_recent_model, display):
                await self._mount_message(
                    ErrorMessage(
                        ...
                        "preference. Check permissions for ~/.code2workspace/"
                    )
                )
            else:
    ...
    async def _set_default_model(self, model_spec: str) -> None:
        ...
        Updates `[models].default` in `~/.code2workspace/config.toml` so that
        ...
        """
        from code2workspace_cli.config import detect_provider
        from code2workspace_cli.model_config import ModelSpec, save_default_model
        ...
        if await asyncio.to_thread(save_default_model, model_spec):
            ...
            await self._mount_message(
                ErrorMessage(
                    "Could not save default model. Check permissions for ~/.code2workspace/"
                )
            )
    ...
    async def _clear_default_model(self) -> None:
        ...
        """
        from code2workspace_cli.model_config import clear_default_model
