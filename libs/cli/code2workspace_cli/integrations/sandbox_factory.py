...
from code2workspace_cli.config import console, get_glyphs
from code2workspace_cli.integrations.sandbox_provider import (
    ...
    *,
    ...
    try:
        ...
        msg = (
            ...
            f"Install it with: pip install 'code2workspace-cli[{provider}]'"
        )
...
def verify_sandbox_deps(provider: str) -> None:
    ...
    if not found:
        msg = (
            ...
            f"Install with: pip install 'code2workspace-cli[{extra}]'"
        )
