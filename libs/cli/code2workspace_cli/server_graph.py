...
def _build_tools(
    ...
    from code2workspace_cli.tools import fetch_url, web_search
...
def make_graph() -> Any:  # noqa: ANN401
    ...
    from code2workspace_cli.agent import create_cli_agent, load_async_subagents
