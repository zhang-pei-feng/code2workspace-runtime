...
- code2workspace skills list [options]
- code2workspace skills create <name> [options]
- code2workspace skills info <name> [options]
- code2workspace skills delete <name> [options]
"""
...
if TYPE_CHECKING:
    ...
    from code2workspace.middleware.skills import SkillMetadata

    from code2workspace_cli.output import OutputFormat
...
def _list(
    ...
    from code2workspace_cli.config import Settings, console, get_glyphs
    ...
    if project:
        ...
        has_code2workspace_skills = project_skills_dir.exists() and any(
        ...
        if not has_code2workspace_skills and not has_agent_skills:
            if output_format == "json":
                from code2workspace_cli.output import write_json
            ...
            console.print(
                ...
                "  code2workspace skills create my-skill --project[/dim]",
                style=theme.MUTED,
            )
            return
        ...
        if not skills:
            ...
            console.print(
                ...
                "  code2workspace skills create my-skill[/dim]",
                style=theme.MUTED,
            )
            return
...
def _create(
    ...
    *,
    ...
    console.print(
        ...
        f"  nano {skill_md}\n"
        "\n"
        "  Add any helper files you need next to SKILL.md and keep the skill\n"
        "  self-contained inside its target directory.\n",
        style=theme.MUTED,
    )
...
def _info(
    ...
    *,
    ...
    from code2workspace_cli.config import Settings, console
    from code2workspace_cli.skills.load import list_skills
...
def setup_skills_parser(
    ...
    *,
    ...
    `code2workspace skills -h` shows skills-specific help, not the
    global help.
    ...
    create_parser = skills_subparsers.add_parser(
        ...
        description=(
            ...
            "~/.code2workspace/<agent>/skills/. "
            "Use --project to create in the project's "
            ".code2workspace/skills/ directory."
        ),
        add_help=False,
...
def execute_skills_command(args: argparse.Namespace) -> None:
    ...
    if args.skills_command in {"list", "ls"}:
        ...
        from code2workspace_cli.ui import show_skills_help
