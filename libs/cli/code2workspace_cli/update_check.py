...
from code2workspace_cli._version import PYPI_URL, USER_AGENT, __version__

if TYPE_CHECKING:
    from pathlib import Path

from code2workspace_cli.model_config import DEFAULT_CONFIG_DIR, DEFAULT_CONFIG_PATH
...
_UPGRADE_COMMANDS: dict[InstallMethod, str] = {
    "uv": "uv tool upgrade code2workspace-cli",
    "brew": "brew upgrade code2workspace-cli",
    "pip": "pip install --upgrade code2workspace-cli",
}
