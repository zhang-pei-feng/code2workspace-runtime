...
from tests.utils import (
    ...
    assert_all_workspace_agent_qualities,
    get_soccer_scores,
    get_weather,
    sample_tool,
)
...
class TestCode2Workspace:
    def test_workspace_agent_with_subagents(self):
        subagents = [
            {
                "name": "weather_agent",
        ...
        agent = create_workspace_agent(tools=[sample_tool], subagents=subagents)
    ...
    def test_workspace_agent_with_subagents_gen_purpose(self):
        subagents = [
            {
                "name": "weather_agent",
                "description": "Use this agent to get the weather",
    ...
    def test_workspace_agent_with_subagents_with_middleware(self):
        subagents = [
            {
                "name": "weather_agent",
                "description": "Use this agent to get the weather",
    ...
    def test_workspace_agent_with_custom_subagents(self):
        subagents = [
            {
                "name": "weather_agent",
                "description": "Use this agent to get the weather",
    ...
    def test_workspace_agent_with_extended_state_and_subagents(self):
        subagents = [
            {
        ...
        agent = create_workspace_agent(tools=[sample_tool], subagents=subagents, middleware=[ResearchMiddleware()])
        assert_all_workspace_agent_qualities(agent)
    ...
    def test_workspace_agent_with_subagents_no_tools(self):
        subagents = [
            {
                "name": "basketball_info_agent",
                "description": "Use this agent to get surface level info on any basketball topic",
    ...
    def test_response_format_tool_strategy(self):
        ...
        agent = create_workspace_agent(response_format=ToolStrategy(schema=StructuredOutput))
