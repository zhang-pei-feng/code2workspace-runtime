...
from code2workspace.backends.protocol import BackendProtocol, EditResult, FileDownloadResponse, ReadResult, WriteResult
...
def mock_get_config(thread_id: str | None = "test-thread-123") -> Generator[None, None, None]:
    ...
    with patch("code2workspace.middleware.summarization.get_config", return_value=config):
        yield
