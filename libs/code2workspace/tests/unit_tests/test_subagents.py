...
class TestSubAgents:
    ...
    def test_create_workspace_agent_routes_async_subagents_from_subagents_param(self) -> None:
    ...
    def test_create_workspace_agent_keeps_sync_subagents_in_task_middleware(self) -> None:
        agent = create_workspace_agent(
            model=GenericFakeChatModel(messages=iter([AIMessage(content="done")])),
            subagents=[
                {
    ...
    def test_subagent_returns_final_message_as_tool_result(self) -> None:
        ...
        parent_agent = create_workspace_agent(
    ...
    def test_subagent_propagates_callbacks_to_model_calls(self) -> None:
        ...
        Regression test for https://github.com/zhang-pei-feng/code2workspace/issues/2315.
        """
    ...
    def test_custom_subagent_does_not_inherit_skills(self, tmp_path: Path) -> None:
        """Test that custom subagents do NOT inherit skills middleware from create_workspace_agent.

        This test verifies that:
        1. When create_workspace_agent is called with skills, only the general-purpose subagent gets SkillsMiddleware
    ...
    def test_general_purpose_subagent_inherits_skills_from_main_agent(self, tmp_path: Path) -> None:
        ...
        This test verifies that:
        1. When create_workspace_agent is called with skills, the general-purpose subagent gets SkillsMiddleware
