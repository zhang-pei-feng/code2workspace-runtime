...
```python
from code2workspace import MemoryMiddleware
...
middleware = MemoryMiddleware(
    backend=backend,
    sources=[
        "~/.code2workspace/AGENTS.md",
        "./.code2workspace/AGENTS.md",
    ],
)

agent = create_workspace_agent(middleware=[middleware])
```
...
<memory_guidelines>
    ...
    **Examples:**
    ...
    User: Can you write me an example for creating a workspace agent in LangChain?
    Agent: Sure, I'll write you an example for creating a workspace agent in LangChain <example code in Python>
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            sources: List of memory file paths to load (e.g., `["~/.code2workspace/AGENTS.md",
                     "./.code2workspace/AGENTS.md"]`).
