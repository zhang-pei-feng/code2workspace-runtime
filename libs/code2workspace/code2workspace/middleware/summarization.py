...
from code2workspace.backends import FilesystemBackend
...
agent = create_workspace_agent(middleware=[summ, tool_mw])
```
...
if TYPE_CHECKING:
    ...
    from code2workspace.backends.protocol import BACKEND_TYPES, BackendProtocol
        ...
        **deprecated_kwargs: Any,
        ...
        Args:
            ...
            truncate_args_settings: Settings for truncating large tool arguments in old messages.
                ...
                Provide a [`TruncateArgsSettings`][code2workspace.middleware.summarization.TruncateArgsSettings]
        ...
        Example:
            ```python
            from code2workspace.middleware.summarization import SummarizationMiddleware
        ...
        if _deprecated_history_prefix is not None:
            warnings.warn(
                "The argument `history_path_prefix` was deprecated in code2workspace 0.5"
