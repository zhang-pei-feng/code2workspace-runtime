...
from code2workspace.backends.utils import _get_file_type
...
" 2>/dev/null"""
    ...
    def _edit_via_upload(
        ...
        old_tmp = f"/tmp/.code2workspace_edit_{uid}_old"  # noqa: S108  # sandbox-internal temp file with 80-bit random uid
        new_tmp = f"/tmp/.code2workspace_edit_{uid}_new"  # noqa: S108
