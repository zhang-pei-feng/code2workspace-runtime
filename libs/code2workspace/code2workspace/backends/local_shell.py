...
class LocalShellBackend(FilesystemBackend, SandboxBackendProtocol):
    ...
    Examples:
        ```python
        from code2workspace.backends import LocalShellBackend
    ...
    def __init__(
        ...
        *,
        ...
        if virtual_mode is None:
            warnings.warn(
                "LocalShellBackend virtual_mode default will change in code2workspace 0.5.0; "
                ...
                "See https://github.com/zhang-pei-feng/code2workspace/blob/main/libs/code2workspace/README.md for usage guidelines.",
                DeprecationWarning,
                stacklevel=2,
            )
            virtual_mode = False
